...
# The last line corresponds to creating a linear model in which y is a function
# of x1 and x2. Write out the form of the linear model. What are the regression 
# coefficients?
#
...
# x2. Describe the results obtained. What are b0, b1, and b2? How do these 
# relate to the true β0, β1, and β2? Can you reject the null hypothesis 
# H0 : β1 = 0? How about the null hypothesis H0 : β2 = 0?
reg1 <- lm(y ~ x1 + x2)
summary(reg.1)
# (d) Now fit a least squares regression to predict y using only x1. Comment on
# your results. Can you reject the null hypothesis H0 :β1 =0?
reg2 <- lm(y ~ x1)
summary(reg.2)
#
...
x2 <- c(x2, 0.8)
y <- c(y,6)
#Re-fit the linear models from (c) to (e) using this new data. What effect does
# this new observation have on the each of the models? In each model, is this 
